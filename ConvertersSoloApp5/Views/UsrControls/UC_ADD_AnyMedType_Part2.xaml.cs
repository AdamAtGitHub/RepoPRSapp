...
{
    public sealed partial class UC_ADD_AnyMedType_Part2 : UserControl
    {
        MediaCapture mediaCapture;
        BitmapImage theProfilePicture;

        public UC_ADD_AnyMedType_Part2()
        {
        ...
        private void AppBarButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            UC_DrillDown_ContentInfo uc_DrillDown_ContentInfo = new UC_DrillDown_ContentInfo();
            uc_DrillDown_ContentInfo.M_Content = m_content;

            listM_Content.Items.Add(uc_DrillDown_ContentInfo);
        }

        private void listM_Content_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            var selected = listM_Content.SelectedItem as UC_DrillDown_ContentInfo;
